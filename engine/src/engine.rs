...
impl Engine {
    ...
    fn execute_buy_signal(
        ...
        let allocation = match determine_position_size(PositionSizingParams {
            ...
            minimum_size_as_allocation: self.config.minimum_size_as_allocation,
            ...
            for (_, ticker, signal) in actionable_signals {
                ...
                let build_insufficient_size_details = || {
                    format_sizing_details(
                        ...
                        self.config.minimum_size_as_allocation,
...
mod tests {
    ...
    fn test_runtime_settings() -> EngineRuntimeSettings {
        EngineRuntimeSettings {
            ...
            local_optimization_max_volume_usd_values: vec![
                1_000_000.0,
                10_000_000.0,
                100_000_000.0,
            ],
    ...
    fn test_execute_buy_signal_sizes_with_adjusted_close() {
        ...
        let expected = match determine_position_size(PositionSizingParams {
            ...
            minimum_size_as_allocation: engine.config.minimum_size_as_allocation,
