...
CREATE TABLE IF NOT EXISTS backtest_cache (
    ...
    balance_training_sharpe_ratio DOUBLE PRECISION,
    balance_training_calmar_ratio DOUBLE PRECISION,
    balance_training_cagr DOUBLE PRECISION,
    balance_training_max_drawdown_ratio DOUBLE PRECISION,
    balance_validation_sharpe_ratio DOUBLE PRECISION,
    balance_validation_calmar_ratio DOUBLE PRECISION,
    balance_validation_cagr DOUBLE PRECISION,
    balance_validation_max_drawdown_ratio DOUBLE PRECISION,
...
VALUES
    ...
    ('ACCOUNT_LIQUIDATION_DEVIATION_BAND_PERCENT', '10'),
    ('IGNORED_TICKERS', '[]'),
    ('ALWAYS_VALIDATION_TICKERS', '["SPY","QQQ"]'),
    ('TRAINING_ALLOCATION_RATIO', '0.65'),
    ...
    ('BALANCE_WINDOW_START_DATE', '2023-01-01'),
    ('BALANCE_WINDOW_END_DATE', '2025-12-31'),
    ('LOCAL_OPTIMIZATION_VERSION', '9'),
    ('LOCAL_OPTIMIZATION_MULTI_START_SEEDS', '0'),
    ('OPTIMIZATION_OBJECTIVE', 'SHARPE'),
    ('OPTIMIZATION_OBJECTIVE_2', 'CAGR'),
    ('AUTO_OPTIMIZATION_ENABLED', 'true'),
    ('AUTO_OPTIMIZATION_DELAY_SECONDS', '300'),
    ('ALLOW_SHORT_SELLING_OPTIMIZATION_ENABLED', 'false'),
    ...
    ('LOCAL_OPTIMIZATION_MAX_UNADJUSTED_PRICE_VALUES', '3,5,7,10,15,20'),
    ('LOCAL_OPTIMIZATION_MAX_VOLUME_USD_VALUES', '1000000,10000000,100000000'),
    ...
    ('AUTO_DAILY_SERVER_UPDATE_ENABLED', 'false'),
    ...
    ('TRADE_SLIPPAGE_RATE', '0.02'),
    ('LIMIT_BUY_PENETRATION_RATIO', '0.05'),
    ...
    ('MIN_TICKER_FLUCTUATION_RATIO', '0.03'),
    ('MAX_TICKER_FLUCTUATION_RATIO', '10'),
